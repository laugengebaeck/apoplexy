...
\begin{longlisting}
	\kotlinfile{../Softwareprodukt/App/app/src/main/java/de/lukasrost/apoplexy/helpers/GamificationDBHelper.kt}
	\caption{Die \texttt{GamificationDBHelper}-Klasse, welche für den Zugriff auf die Datenbank verantwortlich ist.}
	\label{listing:gamificationdb}
\end{longlisting}
